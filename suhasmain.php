      ...
      <div id="absolute">
        ...
        <p>Our department has an outstanding placement statistics and our students have been placed in leading IT companies like INFOSYS, TCS, COGNIZANT, ORACLE, and many more. The department has the Memorandum of Understanding (MoU)
          ...
          <p>The department is being run by well qualified and experienced faculty members with several years of exposure in Computer science & Engineering.
            ...
            <br>
           <div class="container mt-5" style="height:700px;" id="pinboard">
              <div class="row">
                
                <div class="col-12 pt-5" id="pinboard1">
                  <h1 class="text-center"><u>Notice Board</u></h1>
                       
                            <?php
                        include("process.php");
                        $sl="select * from announcement order by date1 desc limit 10";
                        $result=mysqli_query($conn,$sl) or die(mysqli_error($conn));
                        echo "<div class='container' style='height:300px;overflow:scroll;'>
                            <div class='table-responsive'>
                            <table class='table table-light table-bordered table table-md'>";
                        while($row=mysqli_fetch_array($result))
                        {?> 
                          <thead>
                            <tr><td scope="col" ><?php echo "<span id='col1'>".substr($row['date1'],8,10)."</span>";?><br><?php echo "<span id='col2'>".$row['day']."</span>";?><hr class='hr1'> </td><td scope="col" rowspan="2"><?php echo "<span id='text'>".$row['text']."</span>";?> </td></tr>
